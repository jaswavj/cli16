...
<table id="printTable" class="table table-hover mb-0" style="border-collapse: separate; border-spacing: 0; font-size: 12px;">
    <thead style="background: linear-gradient(135deg, #f7fafc 0%, #edf2f7 100%);">
        <tr>
            ...
            <th style="padding: 0.4rem; font-weight: 600; color: #4a5568; border: none; font-size: 0.85rem;">Item Name</th>
            <th style="padding: 0.4rem; font-weight: 600; color: #4a5568; border: none; font-size: 0.85rem;">Price</th>
            <th style="padding: 0.4rem; font-weight: 600; color: #4a5568; border: none; font-size: 0.85rem;">Courier</th>
            <th style="padding: 0.4rem; font-weight: 600; color: #4a5568; border: none; font-size: 0.85rem;">Total</th>
            <th style="padding: 0.4rem; font-weight: 600; color: #4a5568; border: none; font-size: 0.85rem;">Advance/Paid</th>
    ...
    <tbody>
        ...
        <tr style="border-bottom: 1px solid #f1f5f9; transition: all 0.2s;">
            ...
            <td style="padding: 0.4rem; color: #718096; border: none; font-size: 0.9rem;"><a href="https://wa.me/<%=cusPhone%>" target="_blank" style="color: #25D366; text-decoration: none; font-weight: 500;"><%=cusPhone%></a></td>
            <td style="padding: 0.4rem; color: #718096; border: none; font-size: 0.9rem;"><%=itemName%></td>
        ...
        <tr class="due-row" style="border-bottom: 1px solid #f1f5f9; transition: all 0.2s;">
            ...
            <td style="padding: 0.4rem; color: #718096; border: none; font-size: 0.9rem;">
                <% if (cusPhone != null && !cusPhone.trim().isEmpty()) { %>
                    <a href="https://wa.me/<%=cusPhone%>" target="_blank" style="color: #25D366; text-decoration: none; font-weight: 500;"><%=cusPhone%></a>
                <% } else { %>
                    -
                <% } %>
            </td>
            <td style="padding: 0.4rem; color: #718096; border: none; font-size: 0.9rem;"><%=dueItemName%></td>
